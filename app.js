...
app.post("/issue", (req, res) => {
  ...
  books.forEach((book) => {
    book.bookName === requestedBookName ? book.bookState = "Issued" : '';
  });
...
app.post("/return", (req, res) => {
  ...
  books.forEach((book) => {
    book.bookName === requestedBookName ? book.bookState = "Available" : '';
  });
...
app.post('/delete', (req, res) => {
  ...
  books.forEach(book => {
      j = j + 1;
      book.bookName === requestedBookName ? books.splice((j - 1), 1) : '';
  });
